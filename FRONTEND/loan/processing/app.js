...
function goBack() { clearTimeout(timer); window.location.href = '../index.html'; }
...
document.getElementById('view-wallet').addEventListener('click', () => window.location.href = '../../index.html');